...
<div class="container">
                    ...
                    <td scope="row">
                        ...
                        <div class="actions d-flex gap-2">
                            ...
                            <div class="restore">
                                ...
                                <div class="modal fade" id="modalId-restore-{{$apartment->id}}" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" role="dialog" aria-labelledby="modalTitleId-{{$apartment->id}}" aria-hidden="true">
                            ...
                            <div class="delete">
                                ...
                                <!-- Modal Body -->
                                <!-- if you want to close by clicking outside the modal, delete the last endpoint:data-bs-backdrop and data-bs-keyboard -->
                                <div class="modal fade" id="modalId-delete-{{$apartment->id}}" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" role="dialog" aria-labelledby="modalTitleId-{{$apartment->id}}" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-sm" role="document">
    ...
    <a href="{{url('dashboard')}}" class="btn btn-dark primary my-3">Back to dashboard</a>
