                ...
                <form autocomplete="off" action="{{ route('host.apartments.store') }}" method="post"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="title" id="title"
                            aria-describedby="helpTitle" placeholder="your apartment title" class="form-control @error('title') is-invalid @enderror" value="{{old('title')}}">
                    ...
                    <div class="mb-3 position-relative">
                        ...
                        <input type="text" id="address" name="address" class="form-control"
                            placeholder="insert your address" aria-describedby="helpTitle"  class="form-control @error('address') is-invalid @enderror" value="{{old('address')}}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="rooms" id="rooms"
                            aria-describedby="helpRooms" placeholder="rooms number" class="form-control @error('rooms') is-invalid @enderror" value="{{old('rooms')}}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="bathrooms" id="bathrooms"
                            aria-describedby="helpBathroom" placeholder="insert bathrooms number" class="form-control @error('bathrooms') is-invalid @enderror" value="{{old('bathrooms')}}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="beds" id="beds" aria-describedby="helpBeds"
                            placeholder="beds in the apartment" class="form-control @error('beds') is-invalid @enderror" value="{{old('beds')}}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="m_square" id="m_square"
                            aria-describedby="helpMSquare" placeholder="square meters" class="form-control @error('m_square') is-invalid @enderror" value="{{old('m_square')}}">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="description" id="description" rows="4" class="form-control @error('description') is-invalid @enderror" value="{{old('description')}}"></textarea>
                        @error('description')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control" name="thumbnail" id="thumbnail"
                            placeholder="insert a thumbnail" aria-describedby="thumbHelpID" class="form-control @error('thumbnail') is-invalid @enderror">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control" name="gallery[]" id="gallery"
                            placeholder="Select multiple images" aria-describedby="thumbHelpID" multiple  class="form-control @error('gallery') is-invalid @enderror">
