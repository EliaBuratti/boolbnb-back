                            ...
                            <div class="mb-4 row">
                                ...
                                <div class="col-md-6">
                                    <input id="last_name" type="text"
                                        ...
                                        value="{{ old('last_name') }}" autofocus maxlength="40">
                            ...
                            <div class="mb-4 row">
                                ...
                                <div class="col-md-6">
                                    <input id="city" type="text"
                                        ...
                                        value="{{ old('city') }}" autofocus maxlength="30">
                            ...
                            <div class="mb-4 row">
                                ...
                                <div class="col-md-6">
                                    <input id="phone" type="text"
                                        ...
                                        value="{{ old('phone') }}" autocomplete="phone" autofocus maxlength="15">
                            ...
                            <div class="mb-4 row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input @error('host') is-invalid @enderror" type="radio" name="host" id="false"
                                            value="0" {{old('host') == 0 ? 'checked' : ''}}/>
                                        <label class="form-check-label" for="false"> I DON'T want to become a host
                                        </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input @error('host') is-invalid @enderror" type="radio" name="host" id="true"
                                            value="1" {{old('host') == 1 ? 'checked' : ''}}/>
